  ...
  return (
    <div className="flex flex-col gap-8 mt-5">
      ...
      <div className="flex justify-between">
        ...
        <div className="flex gap-2 items-center">
          <Briefcase size={20} />{" "}
          <p className="text-xl">{job?.application?.length} Applicants</p>
        </div>
        <div className="flex gap-2 items-center">
          {job?.isOpen ? (
            <>
      ...
      {job?.recruiter_id === user?.id && (
        <Select onValueChange={handleStatusChange}>
          <SelectTrigger
            className={`w-full ${job?.isOpen ? "bg-green-950" : "bg-red"}`}
          >
            <SelectValue
              placeholder={
      ...
      <h2 className="text-2xl sm:text-3xl font-extrabold">About the Job</h2>
      ...
      {job?.application?.length > 0 && job?.recruiter_id === user?.id && (
        <div className="flex flex-col gap-2">
          <h2 className="text-2xl sm:text-3xl font-extrabold">Applications</h2>
